...
const runDailyPromoLogic = async () => {
  console.log('Running daily promo logic...');
  try {
    ...
    console.error('Error running daily promo logic:', error);
  }
};

function startPromoCronService() {
  // Run every day at 6:00 AM UK time
  cron.schedule('0 6 * * *', runDailyPromoLogic, {
...
module.exports = { startPromoCronService, runDailyPromoLogic };
