...
class MonetagTimerDialog extends StatefulWidget {
  const MonetagTimerDialog({super.key});

  @override
  State<MonetagTimerDialog> createState() => _MonetagTimerDialogState();
}

class _MonetagTimerDialogState extends State<MonetagTimerDialog> {
  late int _timeLeft;
  ...
  void initState() {
    ...
    _updateBrowserTitle("30s left");
    _message = "Watching Sponsor... 30 seconds left";
    _stopwatch.start();
    _startTimer();
