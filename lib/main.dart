          ...
          return StreamBuilder<DocumentSnapshot>(
            ...
            builder: (context, dbSnapshot) {
              ...
              if (dbSnapshot.hasError) {
                return const Center(
                  child: Text(
                    "Error connecting to Vault. Check your connection.",
              ...
              double dogeBalance = (userData?['doge_balance'] ?? 0.0)
                  .toDouble();
              double stakedBalance = (userData?['staked_balance'] ?? 0.0)
                  .toDouble();
              Timestamp? stakeTimestamp =
                  userData?['stake_timestamp'] as Timestamp?;
              ...
              onPressed: () {
                ...
                if (user != null && amount.isNotEmpty) {
                  ...
                  htmlForm.append(
                    _createHiddenInput(
                      'callback_url',
                      'https://golden-paw-vault.onrender.com/ipn',
                    ),
                  );
